...
int main(int argc, char **argv) {
  ...
  // UI CELL FIELDS
  aergia::Quad q;
  ponos::Point2 point(0.617188, 0.0625);
  q.set(point - ponos::vec2(0.01), point + ponos::vec2(0.01));
  app.scene.add(&q);
  ...
  ui.init();
  ui.loadConfigFile("/mnt/windows/gitclones/kim/mazeRBF/configFile",
                    "/mnt/windows/gitclones/kim/mazeRBF", 95);
  if (argc == 4)
